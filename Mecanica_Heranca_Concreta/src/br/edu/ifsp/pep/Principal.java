...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        PessoaFisica pf = adicionarPessoaFisica("123.456.789-00", "Guilherme");
        PessoaJuridica pj = adicionarPessoaJuridica("123.456.789-00", "Leo");
        
        Veiculo v1 = adicionarVeiculo("KIA", 2000, "GEI-8542", "Santos", p);
        Veiculo v2 = adicionarVeiculo("FIAT", 2010, "ABC-1234", "Guaruja", pj);
        Veiculo v3 = adicionarVeiculo("Nissan", 2015, "CDE-4315", "Presidente Epitacio", pf);
        Veiculo v4 = adicionarVeiculo("Ford", 2000, "FDW-9457", "Guarujá", pj);
...
//        joinVeiculoPessoa();
    ...
    private static PessoaFisica adicionarPessoaFisica(String cpf, String nome){
        EntityManager em = enf.createEntityManager();
    ...
    private static PessoaJuridica adicionarPessoaJuridica(String cnpj, String nome){
        EntityManager em = enf.createEntityManager();
    ...
    private static void aggregationFunctionsPorCidade(){
        ...
        System.out.println("\nAggregation Functions por Cidade: ");
            TypedQuery<Object[]> carros = em.createQuery("SELECT v.codigo.cidade, COUNT(v), MAX(v.anoFabricacao), MIN(v.anoFabricacao), SUM(v.anoFabricacao), AVG(v.anoFabricacao)  FROM Veiculo v GROUP BY v.codigo.cidade ORDER BY v.codigo.cidade", Object[].class);
